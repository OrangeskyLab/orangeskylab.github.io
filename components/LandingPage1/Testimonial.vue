<template>
  <section class="overview-block-ptb white-bg iq-loved-customers" id="software-features">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
        ...
        <div class="col-sm-12">
          ...
          >
            <div class="item">
              <CardStyle7>
                <div slot="cardMedia">
                  <img v-rjs="3" alt="#" class="img-fluid rounded-circle" :src="require('../../assets/images/testimonial/client-1.png')">
                </div>
                <div slot="cardHeader">
                  <h5 class="iq-tw-6">
                    Jason Adams
            ...
            <div class="item">
              <CardStyle7>
                <div slot="cardMedia">
                  <img v-rjs="3" alt="client-2.jpg" class="img-fluid rounded-circle" :src="require('../../assets/images/testimonial/client-2.jpg')">
                </div>
                <div slot="cardHeader">
                  <h5 class="iq-tw-6">
                    Jenny Adams
            ...
            <div class="item">
              <CardStyle7>
                <div slot="cardMedia">
                  <img v-rjs="3" alt="#" class="img-fluid rounded-circle" :src="require('../../assets/images/testimonial/client-3.jpg')">
                </div>
                <div slot="cardHeader">
                  <h5 class="iq-tw-6">
                    John Deo
